...
const ConnectDocBtn = ({...props}: ConnectDocBtnProps) => {
  return (
    <Link href='/connect-specialist' className={cx("flex items-center justify-center w-1/2 px-6 text-sm rounded-lg sm:text-base sm:w-2/5 bg-green", props.classNames)}>
